...
public class WeBowlTiger {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 2555, 800);
		...
		separator.setBounds(403, 11, 2, 694);
		frame.getContentPane().add(separator);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_1.setBounds(784, 20, 168, 166);
		frame.getContentPane().add(panel_1);
		panel_1.setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBounds(67, 0, 51, 55);
		panel_1.add(panel);
		panel.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel.setLayout(null);
		
		JTextPane textPane = new JTextPane();
		textPane.setBounds(3, 5, 45, 45);
		panel.add(textPane);
		...
		textPane_28.setBounds(3, 5, 45, 45);
		panel_29.add(textPane_28);
		
		JTextPane textPane_29 = new JTextPane();
		textPane_29.setBackground(SystemColor.menu);
		textPane_29.setBounds(26, 83, 116, 70);
		panel_27.add(textPane_29);
		
		JPanel panel_30 = new JPanel();
		panel_30.setLayout(null);
		panel_30.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_30.setBounds(167, 0, 51, 55);
		...
		textPane_41.setBounds(3, 5, 45, 45);
		panel_42.add(textPane_41);
		
		JTextPane textPane_42 = new JTextPane();
		textPane_42.setBackground(SystemColor.menu);
		textPane_42.setBounds(26, 83, 116, 70);
		panel_40.add(textPane_42);
		
		JPanel panel_43 = new JPanel();
		panel_43.setLayout(null);
		panel_43.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_43.setBounds(1461, 193, 168, 166);
		frame.getContentPane().add(panel_43);
		
		JPanel panel_44 = new JPanel();
		panel_44.setLayout(null);
		panel_44.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_44.setBounds(67, 0, 51, 55);
		...
		textPane_43.setBounds(3, 5, 45, 45);
		panel_44.add(textPane_43);
		
		JPanel panel_45 = new JPanel();
		panel_45.setLayout(null);
		panel_45.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_45.setBounds(117, 0, 51, 55);
		...
		textPane_44.setBounds(3, 5, 45, 45);
		panel_45.add(textPane_44);
		
		JTextPane textPane_45 = new JTextPane();
		textPane_45.setBackground(SystemColor.menu);
		textPane_45.setBounds(26, 83, 116, 70);
		panel_43.add(textPane_45);
		
		JPanel panel_46 = new JPanel();
		panel_46.setLayout(null);
		panel_46.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_46.setBounds(1628, 193, 168, 166);
		frame.getContentPane().add(panel_46);
		
		JPanel panel_47 = new JPanel();
		panel_47.setLayout(null);
		panel_47.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_47.setBounds(67, 0, 51, 55);
		...
		textPane_46.setBounds(3, 5, 45, 45);
		panel_47.add(textPane_46);
		
		JPanel panel_48 = new JPanel();
		panel_48.setLayout(null);
		panel_48.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_48.setBounds(117, 0, 51, 55);
		...
		textPane_47.setBounds(3, 5, 45, 45);
		panel_48.add(textPane_47);
		
		JTextPane textPane_48 = new JTextPane();
		textPane_48.setBackground(SystemColor.menu);
		textPane_48.setBounds(26, 83, 116, 70);
		panel_46.add(textPane_48);
		
		JPanel panel_49 = new JPanel();
		panel_49.setLayout(null);
		panel_49.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_49.setBounds(1798, 193, 168, 166);
		frame.getContentPane().add(panel_49);
		
		JPanel panel_50 = new JPanel();
		panel_50.setLayout(null);
		panel_50.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_50.setBounds(67, 0, 51, 55);
		...
		textPane_49.setBounds(3, 5, 45, 45);
		panel_50.add(textPane_49);
		
		JPanel panel_51 = new JPanel();
		panel_51.setLayout(null);
		panel_51.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_51.setBounds(117, 0, 51, 55);
		...
		textPane_52.setBounds(3, 5, 45, 45);
		panel_53.add(textPane_52);
		
		JPanel panel_54 = new JPanel();
		panel_54.setLayout(null);
		panel_54.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_54.setBounds(117, 0, 51, 55);
		...
		textPane_55.setBounds(3, 5, 45, 45);
		panel_56.add(textPane_55);
		
		JPanel panel_57 = new JPanel();
		panel_57.setLayout(null);
		panel_57.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_57.setBounds(117, 0, 51, 55);
		...
		textPane_58.setBounds(3, 5, 45, 45);
		panel_59.add(textPane_58);
		
		JPanel panel_60 = new JPanel();
		panel_60.setLayout(null);
		panel_60.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_60.setBounds(117, 0, 51, 55);
		...
		textPane_59.setBounds(3, 5, 45, 45);
		panel_60.add(textPane_59);
		
		JTextPane textPane_60 = new JTextPane();
		textPane_60.setBackground(SystemColor.menu);
		textPane_60.setBounds(26, 83, 116, 70);
		panel_58.add(textPane_60);
		
		JPanel panel_61 = new JPanel();
		panel_61.setLayout(null);
		panel_61.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_61.setBounds(167, 0, 51, 55);
		...
		textPane_61.setBounds(3, 5, 45, 45);
		panel_61.add(textPane_61);
		
		JLabel lblEloy = new JLabel("Eloy");
		lblEloy.setHorizontalAlignment(SwingConstants.CENTER);
		lblEloy.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblEloy.setBounds(423, 232, 335, 87);
		...
		panel_62.setBounds(784, 366, 168, 166);
		frame.getContentPane().add(panel_62);
		
		JPanel panel_63 = new JPanel();
		panel_63.setLayout(null);
		panel_63.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_63.setBounds(67, 0, 51, 55);
		...
		textPane_62.setBounds(3, 5, 45, 45);
		panel_63.add(textPane_62);
		
		JPanel panel_64 = new JPanel();
		panel_64.setLayout(null);
		panel_64.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_64.setBounds(117, 0, 51, 55);
		...
		textPane_65.setBounds(3, 5, 45, 45);
		panel_66.add(textPane_65);
		
		JPanel panel_67 = new JPanel();
		panel_67.setLayout(null);
		panel_67.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_67.setBounds(117, 0, 51, 55);
		...
		textPane_66.setBounds(3, 5, 45, 45);
		panel_67.add(textPane_66);
		
		JTextPane textPane_67 = new JTextPane();
		textPane_67.setBackground(SystemColor.menu);
		textPane_67.setBounds(26, 83, 116, 70);
		panel_65.add(textPane_67);
		...
		panel_68.setBounds(1123, 366, 168, 166);
		frame.getContentPane().add(panel_68);
		
		JPanel panel_69 = new JPanel();
		panel_69.setLayout(null);
		panel_69.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_69.setBounds(67, 0, 51, 55);
		...
		textPane_68.setBounds(3, 5, 45, 45);
		panel_69.add(textPane_68);
		
		JPanel panel_70 = new JPanel();
		panel_70.setLayout(null);
		panel_70.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_70.setBounds(117, 0, 51, 55);
		...
		textPane_71.setBounds(3, 5, 45, 45);
		panel_72.add(textPane_71);
		
		JPanel panel_73 = new JPanel();
		panel_73.setLayout(null);
		panel_73.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_73.setBounds(117, 0, 51, 55);
		...
		textPane_72.setBounds(3, 5, 45, 45);
		panel_73.add(textPane_72);
		
		JTextPane textPane_73 = new JTextPane();
		textPane_73.setBackground(SystemColor.menu);
		textPane_73.setBounds(26, 83, 116, 70);
		panel_71.add(textPane_73);
		...
		panel_74.setBounds(1461, 366, 168, 166);
		frame.getContentPane().add(panel_74);
		
		JPanel panel_75 = new JPanel();
		panel_75.setLayout(null);
		panel_75.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_75.setBounds(67, 0, 51, 55);
		...
		textPane_74.setBounds(3, 5, 45, 45);
		panel_75.add(textPane_74);
		
		JPanel panel_76 = new JPanel();
		panel_76.setLayout(null);
		panel_76.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_76.setBounds(117, 0, 51, 55);
		...
		textPane_75.setBounds(3, 5, 45, 45);
		panel_76.add(textPane_75);
		
		JTextPane textPane_76 = new JTextPane();
		textPane_76.setBackground(SystemColor.menu);
		textPane_76.setBounds(26, 83, 116, 70);
		panel_74.add(textPane_76);
		...
		panel_77.setBounds(1628, 366, 168, 166);
		frame.getContentPane().add(panel_77);
		
		JPanel panel_78 = new JPanel();
		panel_78.setLayout(null);
		panel_78.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_78.setBounds(67, 0, 51, 55);
		...
		textPane_77.setBounds(3, 5, 45, 45);
		panel_78.add(textPane_77);
		
		JPanel panel_79 = new JPanel();
		panel_79.setLayout(null);
		panel_79.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_79.setBounds(117, 0, 51, 55);
		...
		textPane_78.setBounds(3, 5, 45, 45);
		panel_79.add(textPane_78);
		
		JTextPane textPane_79 = new JTextPane();
		textPane_79.setBackground(SystemColor.menu);
		textPane_79.setBounds(26, 83, 116, 70);
		panel_77.add(textPane_79);
		...
		panel_80.setBounds(1798, 366, 168, 166);
		frame.getContentPane().add(panel_80);
		
		JPanel panel_81 = new JPanel();
		panel_81.setLayout(null);
		panel_81.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_81.setBounds(67, 0, 51, 55);
		...
		textPane_80.setBounds(3, 5, 45, 45);
		panel_81.add(textPane_80);
		
		JPanel panel_82 = new JPanel();
		panel_82.setLayout(null);
		panel_82.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_82.setBounds(117, 0, 51, 55);
		...
		textPane_81.setBounds(3, 5, 45, 45);
		panel_82.add(textPane_81);
		
		JTextPane textPane_82 = new JTextPane();
		textPane_82.setBackground(SystemColor.menu);
		textPane_82.setBounds(26, 83, 116, 70);
		panel_80.add(textPane_82);
		...
		panel_83.setBounds(1967, 366, 168, 166);
		frame.getContentPane().add(panel_83);
		
		JPanel panel_84 = new JPanel();
		panel_84.setLayout(null);
		panel_84.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_84.setBounds(67, 0, 51, 55);
		...
		textPane_83.setBounds(3, 5, 45, 45);
		panel_84.add(textPane_83);
		
		JPanel panel_85 = new JPanel();
		panel_85.setLayout(null);
		panel_85.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_85.setBounds(117, 0, 51, 55);
		...
		textPane_84.setBounds(3, 5, 45, 45);
		panel_85.add(textPane_84);
		
		JTextPane textPane_85 = new JTextPane();
		textPane_85.setBackground(SystemColor.menu);
		textPane_85.setBounds(26, 83, 116, 70);
		panel_83.add(textPane_85);
		...
		panel_86.setBounds(2136, 366, 168, 166);
		frame.getContentPane().add(panel_86);
		
		JPanel panel_87 = new JPanel();
		panel_87.setLayout(null);
		panel_87.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_87.setBounds(67, 0, 51, 55);
		...
		textPane_86.setBounds(3, 5, 45, 45);
		panel_87.add(textPane_86);
		
		JPanel panel_88 = new JPanel();
		panel_88.setLayout(null);
		panel_88.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_88.setBounds(117, 0, 51, 55);
		...
		textPane_87.setBounds(3, 5, 45, 45);
		panel_88.add(textPane_87);
		
		JTextPane textPane_88 = new JTextPane();
		textPane_88.setBackground(SystemColor.menu);
		textPane_88.setBounds(26, 83, 116, 70);
		panel_86.add(textPane_88);
		...
		panel_89.setBounds(2305, 366, 218, 166);
		frame.getContentPane().add(panel_89);
		
		JPanel panel_90 = new JPanel();
		panel_90.setLayout(null);
		panel_90.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_90.setBounds(67, 0, 51, 55);
		...
		textPane_89.setBounds(3, 5, 45, 45);
		panel_90.add(textPane_89);
		
		JPanel panel_91 = new JPanel();
		panel_91.setLayout(null);
		panel_91.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_91.setBounds(117, 0, 51, 55);
		...
		textPane_90.setBounds(3, 5, 45, 45);
		panel_91.add(textPane_90);
		
		JTextPane textPane_91 = new JTextPane();
		textPane_91.setBackground(SystemColor.menu);
		textPane_91.setBounds(26, 83, 116, 70);
		panel_89.add(textPane_91);
		
		JPanel panel_92 = new JPanel();
		panel_92.setLayout(null);
		panel_92.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_92.setBounds(167, 0, 51, 55);
		...
		textPane_92.setBounds(3, 5, 45, 45);
		panel_92.add(textPane_92);
		
		JLabel lblSerkan = new JLabel("Serkan");
		lblSerkan.setHorizontalAlignment(SwingConstants.CENTER);
		lblSerkan.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblSerkan.setBounds(423, 405, 335, 87);
		...
		panel_93.setBounds(783, 539, 168, 166);
		frame.getContentPane().add(panel_93);
		
		JPanel panel_94 = new JPanel();
		panel_94.setLayout(null);
		panel_94.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_94.setBounds(67, 0, 51, 55);
		...
		textPane_93.setBounds(3, 5, 45, 45);
		panel_94.add(textPane_93);
		
		JPanel panel_95 = new JPanel();
		panel_95.setLayout(null);
		panel_95.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_95.setBounds(117, 0, 51, 55);
		...
		textPane_94.setBounds(3, 5, 45, 45);
		panel_95.add(textPane_94);
		
		JTextPane textPane_95 = new JTextPane();
		textPane_95.setBackground(SystemColor.menu);
		textPane_95.setBounds(26, 83, 116, 70);
		panel_93.add(textPane_95);
		...
		panel_96.setBounds(953, 539, 168, 166);
		frame.getContentPane().add(panel_96);
		
		JPanel panel_97 = new JPanel();
		panel_97.setLayout(null);
		panel_97.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_97.setBounds(67, 0, 51, 55);
		...
		textPane_96.setBounds(3, 5, 45, 45);
		panel_97.add(textPane_96);
		
		JPanel panel_98 = new JPanel();
		panel_98.setLayout(null);
		panel_98.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_98.setBounds(117, 0, 51, 55);
		...
		textPane_97.setBounds(3, 5, 45, 45);
		panel_98.add(textPane_97);
		
		JTextPane textPane_98 = new JTextPane();
		textPane_98.setBackground(SystemColor.menu);
		textPane_98.setBounds(26, 83, 116, 70);
		panel_96.add(textPane_98);
		...
		panel_99.setBounds(1122, 539, 168, 166);
		frame.getContentPane().add(panel_99);
		
		JPanel panel_100 = new JPanel();
		panel_100.setLayout(null);
		panel_100.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_100.setBounds(67, 0, 51, 55);
		...
		textPane_99.setBounds(3, 5, 45, 45);
		panel_100.add(textPane_99);
		
		JPanel panel_101 = new JPanel();
		panel_101.setLayout(null);
		panel_101.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_101.setBounds(117, 0, 51, 55);
		...
		textPane_100.setBounds(3, 5, 45, 45);
		panel_101.add(textPane_100);
		
		JTextPane textPane_101 = new JTextPane();
		textPane_101.setBackground(SystemColor.menu);
		textPane_101.setBounds(26, 83, 116, 70);
		panel_99.add(textPane_101);
		...
		panel_102.setBounds(1291, 539, 168, 166);
		frame.getContentPane().add(panel_102);
		
		JPanel panel_103 = new JPanel();
		panel_103.setLayout(null);
		panel_103.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_103.setBounds(67, 0, 51, 55);
		...
		textPane_102.setBounds(3, 5, 45, 45);
		panel_103.add(textPane_102);
		
		JPanel panel_104 = new JPanel();
		panel_104.setLayout(null);
		panel_104.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_104.setBounds(117, 0, 51, 55);
		...
		textPane_103.setBounds(3, 5, 45, 45);
		panel_104.add(textPane_103);
		
		JTextPane textPane_104 = new JTextPane();
		textPane_104.setBackground(SystemColor.menu);
		textPane_104.setBounds(26, 83, 116, 70);
		panel_102.add(textPane_104);
		...
		panel_105.setBounds(1460, 539, 168, 166);
		frame.getContentPane().add(panel_105);
		
		JPanel panel_106 = new JPanel();
		panel_106.setLayout(null);
		panel_106.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_106.setBounds(67, 0, 51, 55);
		...
		textPane_105.setBounds(3, 5, 45, 45);
		panel_106.add(textPane_105);
		
		JPanel panel_107 = new JPanel();
		panel_107.setLayout(null);
		panel_107.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_107.setBounds(117, 0, 51, 55);
		...
		textPane_106.setBounds(3, 5, 45, 45);
		panel_107.add(textPane_106);
		
		JTextPane textPane_107 = new JTextPane();
		textPane_107.setBackground(SystemColor.menu);
		textPane_107.setBounds(26, 83, 116, 70);
		panel_105.add(textPane_107);
		...
		panel_108.setBounds(1627, 539, 168, 166);
		frame.getContentPane().add(panel_108);
		
		JPanel panel_109 = new JPanel();
		panel_109.setLayout(null);
		panel_109.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_109.setBounds(67, 0, 51, 55);
		...
		textPane_108.setBounds(3, 5, 45, 45);
		panel_109.add(textPane_108);
		
		JPanel panel_110 = new JPanel();
		panel_110.setLayout(null);
		panel_110.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_110.setBounds(117, 0, 51, 55);
		...
		textPane_109.setBounds(3, 5, 45, 45);
		panel_110.add(textPane_109);
		
		JTextPane textPane_110 = new JTextPane();
		textPane_110.setBackground(SystemColor.menu);
		textPane_110.setBounds(26, 83, 116, 70);
		panel_108.add(textPane_110);
		...
		panel_111.setBounds(1797, 539, 168, 166);
		frame.getContentPane().add(panel_111);
		
		JPanel panel_112 = new JPanel();
		panel_112.setLayout(null);
		panel_112.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_112.setBounds(67, 0, 51, 55);
		...
		textPane_111.setBounds(3, 5, 45, 45);
		panel_112.add(textPane_111);
		
		JPanel panel_113 = new JPanel();
		panel_113.setLayout(null);
		panel_113.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_113.setBounds(117, 0, 51, 55);
		...
		textPane_112.setBounds(3, 5, 45, 45);
		panel_113.add(textPane_112);
		
		JTextPane textPane_113 = new JTextPane();
		textPane_113.setBackground(SystemColor.menu);
		textPane_113.setBounds(26, 83, 116, 70);
		panel_111.add(textPane_113);
		...
		panel_114.setBounds(1966, 539, 168, 166);
		frame.getContentPane().add(panel_114);
		
		JPanel panel_115 = new JPanel();
		panel_115.setLayout(null);
		panel_115.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_115.setBounds(67, 0, 51, 55);
		...
		textPane_114.setBounds(3, 5, 45, 45);
		panel_115.add(textPane_114);
		
		JPanel panel_116 = new JPanel();
		panel_116.setLayout(null);
		panel_116.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_116.setBounds(117, 0, 51, 55);
		...
		textPane_115.setBounds(3, 5, 45, 45);
		panel_116.add(textPane_115);
		
		JTextPane textPane_116 = new JTextPane();
		textPane_116.setBackground(SystemColor.menu);
		textPane_116.setBounds(26, 83, 116, 70);
		panel_114.add(textPane_116);
		...
		panel_117.setBounds(2135, 539, 168, 166);
		frame.getContentPane().add(panel_117);
		
		JPanel panel_118 = new JPanel();
		panel_118.setLayout(null);
		panel_118.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_118.setBounds(67, 0, 51, 55);
		...
		textPane_117.setBounds(3, 5, 45, 45);
		panel_118.add(textPane_117);
		
		JPanel panel_119 = new JPanel();
		panel_119.setLayout(null);
		panel_119.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_119.setBounds(117, 0, 51, 55);
		...
		textPane_118.setBounds(3, 5, 45, 45);
		panel_119.add(textPane_118);
		
		JTextPane textPane_119 = new JTextPane();
		textPane_119.setBackground(SystemColor.menu);
		textPane_119.setBounds(26, 83, 116, 70);
		panel_117.add(textPane_119);
		...
		panel_120.setBounds(2304, 539, 218, 166);
		frame.getContentPane().add(panel_120);
		
		JPanel panel_121 = new JPanel();
		panel_121.setLayout(null);
		panel_121.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_121.setBounds(67, 0, 51, 55);
		...
		textPane_120.setBounds(3, 5, 45, 45);
		panel_121.add(textPane_120);
		
		JPanel panel_122 = new JPanel();
		panel_122.setLayout(null);
		panel_122.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_122.setBounds(117, 0, 51, 55);
		...
		textPane_121.setBounds(3, 5, 45, 45);
		panel_122.add(textPane_121);
		
		JTextPane textPane_122 = new JTextPane();
		textPane_122.setBackground(SystemColor.menu);
		textPane_122.setBounds(26, 83, 116, 70);
		panel_120.add(textPane_122);
		
		JPanel panel_123 = new JPanel();
		panel_123.setLayout(null);
		panel_123.setBorder(new LineBorder(new Color(0, 0, 0), 3));
		panel_123.setBounds(167, 0, 51, 55);
		...
		textPane_123.setBounds(3, 5, 45, 45);
		panel_123.add(textPane_123);
		
		JLabel lblLe = new JLabel("Le");
		lblLe.setHorizontalAlignment(SwingConstants.CENTER);
		lblLe.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblLe.setBounds(422, 578, 335, 87);
